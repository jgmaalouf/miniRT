...
/*   Updated: 2023/03/12 15:57:23 by amorvai          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool	hit_sphere(const t_ray r, double t_max, t_sphere sp, double *root)
{
	...
	c = vec3_length_squared(oc) - sp.diameter / 2 * sp.diameter / 2;
...
bool	hit_sphere_record(const t_ray r, double t_max, t_sphere sp, t_hit_record *temp_rec)
{
